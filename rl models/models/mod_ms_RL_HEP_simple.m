function [fval,fit] = mod_ms_RL_HEP_simple(behavData,q, doprior,dofit,varargin)
...
qt = norm2par('ms_RL_HEP_simple',q); % transform parameters from gaussian space to model space
